...
| Criterion                            | Formula for Settling Time (T_s)                                |
| :----------------------------------- | :------------------------------------------------------------- |
| **2% Criterion** (More common)       | (T_{s,2%} \approx \frac{4}{\zeta \omega_n} = \frac{4}{\sigma}) |
| **5% Criterion** (Less conservative) | (T_{s,5%} \approx \frac{3}{\zeta \omega_n} = \frac{3}{\sigma}) |
